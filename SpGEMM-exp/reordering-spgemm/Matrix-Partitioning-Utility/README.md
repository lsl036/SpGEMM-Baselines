...
Please see the respective readme files of each program to find detailed information on how to use them. After doing the partition, use Converter to convert the partition-ids to reorder row-ids.